...
const NewsArticle = () => {
  ...
  Pune / Amsterdam — December 22, 2025
          ...
          <div className="prose prose-lg prose-invert max-w-none animate-article-body text-white-200">
            ...
            <h3 className="font-caption font-bold text-muted-foreground text-xl mb-4">
              Strategic Context
            </h3>
            <p className="font-caption text-consulting-dark/85 text-muted-foreground mb-8">
            ...
            <p className="font-caption text-consulting-dark/85 text-muted-foreground mb-4">
              Under the terms of the engagement:
            </p>
            <ul className="font-caption text-consulting-dark/85 text-muted-foreground mb-8 space-y-3 list-disc pl-6">
           ...
           <blockquote className="border-l-4 border-gray-500 pl-6 py-4 my-8 bg-white/5 rounded-r-xl">
              ...
              <p className="font-caption text-muted-foreground/90 text-muted-foreground italic">
              ...
              <footer className="mt-4 font-caption text-slate-200 text-base">
            ...
            <p className="font-caption text-consulting-dark/85 text-muted-foreground">
