    ...
    <section id="contact" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20 animate-elegant-fade-up">
          <h2 className="font-caption text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-consulting-dark mb-6 sm:mb-8 animate-soft-glow text-shadow-soft px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
          {contactInfo.map((info, index) => (
            <Card 
              key={info.title}
              className="p-6 sm:p-8 lg:p-10 bg-gradient-card border-consulting-subtle hover:shadow-premium transition-all duration-500 animate-premium-scale hover:scale-105"
